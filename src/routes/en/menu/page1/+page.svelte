...
<div class="carousel w-full mb-20">
  ...
  <div class="carousel-item relative w-full">
    <div class="w-full">
        ...
        <div class="grid md:grid-cols-2 gap-1">
          ...
          <div>
            ...
            <MenuItem
              name="Chili Bean"
              price="15.50"
              description="Our award-winning chili beans, topped with cheddar cheese and onions."
            />
        ...
        <div class="grid md:grid-cols-2 gap-1 text-center">
          <div>
            <MenuItem
              name="Steak"
              price="20.99"
              description="New York Steak served with two eggs."
            />
            <MenuItem
              name="Pork Chops"
              price="18.50"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-1 text-center">
          ...
          <div>
            ...
            <MenuItem
              name="Prime Rib"
              price="16.99"
              description="Prime rib, onions, bell peppers, scrambled with two eggs. Served with hash browns."
            />
          </div>
        </div>
      </div>
      ...
      <div
        class="grid grid-cols-1 md:grid-cols-2 mb-6 text-center md:text-left"
      >
        <div>
          <h3
          ...
          <MenuItem
            name="Fruit"
            price="12.99"
            description="Strawberry or blueberry, with cream cheese."
          />
          <MenuItem
            name="Molly's"
            price="14.99"
